class Starship:
    def __init__(self,id, name, model, manufacturer, cost_in_credits, length, crew, passengers, cargo_capacity, consumables, hyperdrive_rating, mglt, starship_class, pilots, films):
        self.id = id
        self.name = name
        self.model = model
